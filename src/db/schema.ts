...
import { Channel, ChannelStat, ChannelsExistStat, DM, DataStore, DmStat, DmsExistStat, Message, MessageStat, Notif, Profile, PwReset, TokenPair, User, channelStat, dmStat, messageStat, msgsExistStat } from '../interfaces';
...
export const notifSchema = new Schema<Notif>({
  channelId: Number,
  dmId: Number,

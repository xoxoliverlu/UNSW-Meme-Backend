  ...
  describe('Testing messageShare', () => {
    describe('errors', () => {
      ...
      test('authorised user has not joined the channel or DM they are trying to share the message to', () => {
        const register = requestAuthRegister('dimpi@gmail.com', 'dimpidimpidimpi', 'dimpi', 'garnepudi');
        const register2 = authRegister('dimpigarnepudi@gmail.com', 'dimpigarnepudi', 'dimpi', 'garnepudi');
        ...
        const channel2 = requstChannelsCreate(register2.token, 'My Party', false);
    ...
    describe('success cases', () => {
      test('message is shared to another channel', () => {
        ...
        requestMessageSend(register2.token, channel.channelId, 'information');

...
describe('Testing messageSendDm', () => {
    test('messageSendDm success', () => {
      const registerOwner = authRegister('dimpi.garnepudi@gmail.com', 'dimpi123', 'Dimpi', 'Garnepudi');
      const register1 = authRegister('tanisha.gupta@gmail.com', 'tanisha123', 'Tanisha', 'Gupta');
      const register2 = authRegister('madhu.shrestha@gmail.com', 'madhu123', 'Madhu', 'Shrestha');
      const register3 = authRegister('emily.chang@gmail.com', 'emily123', 'Emily', 'Chang');

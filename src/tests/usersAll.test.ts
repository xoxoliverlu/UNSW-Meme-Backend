...
test('Successful usersAllV1 Test.', () => {
  const user1 = authRegisterV2('fadyS@gmail.com', 'password', 'Fady', 'Sadek');
  const user2 = authRegisterV2('JohnP@gmail.com', '123456', 'John', 'Paul');
  const user3 = authRegisterV2('SimonM@gmail.com', 'pass123', 'Simon', 'Minter');
